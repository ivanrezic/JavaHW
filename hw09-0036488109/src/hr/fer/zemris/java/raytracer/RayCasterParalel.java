...
public class RayCasterParalel {
	...
	private static IRayTracerProducer getIRayTracerProducer() {
		return new IRayTracerProducer() {
			 ...
			 * 
			 * @see
			 * hr.fer.zemris.java.raytracer.model.IRayTracerProducer#produce(hr.
			 * fer.zemris.java.raytracer.model.Point3D,
			 * hr.fer.zemris.java.raytracer.model.Point3D,
			 * hr.fer.zemris.java.raytracer.model.Point3D, double, double, int,
			 * int, long,
			 * hr.fer.zemris.java.raytracer.model.IRayTracerResultObserver)
			 */
			@Override
